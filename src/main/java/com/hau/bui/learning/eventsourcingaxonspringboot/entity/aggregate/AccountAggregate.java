...
import com.hau.bui.learning.eventsourcingaxonspringboot.command.CreateAccountCommand;
import com.hau.bui.learning.eventsourcingaxonspringboot.command.CreditMoneyCommand;
import com.hau.bui.learning.eventsourcingaxonspringboot.command.DebitMoneyCommand;
import com.hau.bui.learning.eventsourcingaxonspringboot.event.*;
...
public class AccountAggregate {
    ...
    @EventSourcingHandler
    private void on(MoneyCreditedEvent moneyCreditedEvent) {
    ...
    @EventSourcingHandler
    private void on(MoneyDebitedEvent moneyDebitedEvent) {
